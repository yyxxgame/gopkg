...
func (mr *mockIEsClientMockRecorder) Insert(chain any) *gomock.Call {
...
func (mr *mockIEsClientMockRecorder) InsertCtx(ctx, chain any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *mockIEsClientMockRecorder) Query(chain any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *mockIEsClientMockRecorder) QueryCtx(ctx, chain any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *mockIEsClientMockRecorder) Upsert(chain any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *mockIEsClientMockRecorder) UpsertCtx(ctx, chain any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
